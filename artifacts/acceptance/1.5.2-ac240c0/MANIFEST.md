...
- 提交：`ac240c00038dfcd7be986ee286f556a3cdab9d33`
- 版本：`1.5.2`
- 生成时间：2026-09-23T13:44:48.601Z
- **结论：存在未通过项 ❌**

| 检查项 | 结果 | 读数 | 日志 |
| --- | --- | --- | --- |
| 提交与工作区：工作区干净（除 design/card-frames 未跟踪，见台账 §16.36.6） | ❌ | 未提交改动 7 项：?? scripts/acceptance-snapshot.js ; ?? scripts/android-native-apk-inspect.js ; ?? scripts/android-native-cdp-eval.js | — |
